...
$query = "INSERT INTO wisatadiy (id_wisatadiy, hari, tanggaltul, penulis, judul, name, size, type, template, infogambar, tempatwisata, provinsi, kabkota, jeniswisata, artikel, file, counter, ip, tanggal, jam, usernama, status, jenis, kategori) VALUES ('', '$hari', '$tanggaltul', '$penulis', '$judul', '$fileName', '$fileSize', '$fileType', '$tmpName', '$infogambar0', '$tempatwisata', '$provinsi', '$kabkota', '$jeniswisata', '$artikel', '$file', '$counter', '$ip', '$tanggal', '$jam', '$username', '$status', '$jenis', '$kategori')";
//mysql_query($query);
