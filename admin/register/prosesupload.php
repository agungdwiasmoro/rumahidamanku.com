...
// jika validasi type file terpenuhi
	...
	$query = "INSERT INTO user(user_id, nama, username, password, email, telepon, provinsi, kodkab, namausaha, level, useradmint, statususer) VALUES('','$nama','$username','$password','$email','$telepon','$provinsi','$kodkab',' $namausaha', '$level', '$useradmint', '$status')";
