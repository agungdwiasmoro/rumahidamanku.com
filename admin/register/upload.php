...
$query = "INSERT INTO profilpromo(id_profilpromo, name, size, type, template, namephoto0, namausaha, jamkerja, bidangusaha, alamatuser, spec, handphone0, email, website, file, ip, tanggal, jam, kodkab, provinsi, status, bayar, totaljeda, usernama, counter, masaberlak, kontrakcounter, keterangan, statusloker) VALUES('', '$fileName', '$fileSize', '$fileType', '$tmpName', '$namephoto', '$namausaha', '$jamkerja', '$bidangusaha', '$alamatuser', '$spec', '$handphone0', '$email', '$website', '$file', '$ip', '$tanggal', '$jam', '$kodkab', '$provinsi', '$status', '$bayar', '$totaljeda', '$username', '$counter', '$masaberlak', '$kontrakcounter', '$keterangan', '$statusloker')";
