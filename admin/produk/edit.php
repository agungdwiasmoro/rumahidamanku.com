					...
					?>
						<div class="col-md-6 col-md-offset-3 ">
							...
							<div class="form-group">
								...
								<input type="text" name="harganormal" id="harganormal" value="<?php echo $row_konekproddiy['harganormal']; ?>" placeholder="Harga Normal Produk Anda" class="form-control" required>
							</div>
							<div class="form-group">
								<label>Stock **</label>
							...
							<div class="form-group">
								...
								<input type="text" name="hargapromo" id="hargapromo" value="<?php echo $row_konekproddiy['hargapromo']; ?>" placeholder="Harga Khusus Promo" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="hargadiskon" id="hargadiskon" value="<?php echo $row_konekproddiy['hargadiskon']; ?>" placeholder="Harga Diskon" class="form-control" >
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<select title="pilih status produk, produk diskon, produk masa promosi baru atau produk harga normal"  name="posisi" id="posisi" class="form-control">
									...
									<option value="normal">harga produk normal</option>
									<option value="diskon">harga produk diskon</option>
									<option value="promo">harga produk promo</option>
