...
$goomapping1 = mysql_real_escape_string($_POST['goomapping1']);
$goomapping2 = mysql_real_escape_string($_POST['goomapping2']);
$goomapping3 = mysql_real_escape_string($_POST['goomapping3']);
$goomapping4 = mysql_real_escape_string($_POST['goomapping4']);
$goomapping5 = mysql_real_escape_string($_POST['goomapping5']);
