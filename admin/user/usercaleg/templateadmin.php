				...
				<!-- sidebar menu: : style can be found in sidebar.less -->
					<ul class="sidebar-menu" data-widget="tree">
						<li class="header">MENU ADMINISTRATOR</li>
							<li><a href="usahaterdaftar.php"><i class="fa fa-bookmark"></i> <span>Profil</span></a></li>
							<li><a href="transaksi.php"><i class="fa fa-dollar"></i> <span>Edit Profil</span></a></li>
							<li><a href=""><i class="fa fa-dollar"></i><span>Tentang Kami</span></a></li>
							<li><a href=""><i><span>Dapil</span></i></a></li>
							<li><a href=""><i><span>Tambah Dapil</span></i></a></li>
						<li class="header"></li>
