				...
				<!-- sidebar menu: : style can be found in sidebar.less -->
					<ul class="sidebar-menu" data-widget="tree">
						<li class="header">MENU ADMINISTRATOR</li>
							...
							<li><a href="#"><i class="fa fa-book"></i> <span>News</span></a></li>
						<li class="header">MENU USER</li>
							...
							<a href="#">
								...
								<span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
								<ul class="treeview-menu">
									<li><a href="useradmin.php"><i class="fa fa-circle-o"></i> User Admin</a></li>
									<li><a href="usersales.php"><i class="fa fa-circle-o"></i> User Sales</a></li>
									<li><a href="index.php"><i class="fa fa-circle-o"></i> User Usaha</a></li>
								</ul>
							</a>
							</li>
						</li>
