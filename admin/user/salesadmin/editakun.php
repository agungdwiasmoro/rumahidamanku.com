					...
					?>
						<div class="col-md-6 col-md-offset-3 ">
							...
							<div class="form-group">
								...
								<input type="password" name="password" id="password" value="<?php echo $row_konekuser['password']; ?>" placeholder="Input Password" class="form-control" required >
							</div>
							<div class="form-group">
								<label>E-mail **</label>
								<input type="text" name="email" id="email" value="<?php echo $row_konekuser['email']; ?>" placeholder="Masukan email anda" class="form-control" required >
							</div>
							<div class="form-group">
								<label>Telepon *</label>
							...
							<div class="form-group">
								...
								<input type="text" name="kodkab" id="kodkab" value="<?php echo $row_konekuser['kodkab']; ?>" placeholder="ex: Kabupaten Purworejo"class="form-control" required>
							</div>
							<div class="form-group">
								<label>Nama Usaha **</label>
								<input type="text" name="namausaha" id="namausaha" value="<?php echo $row_konekuser['namausaha']; ?>" placeholder="Tuliskan Nama Usaha Anda" class="form-control" required>
							</div>
