...
$query_mysql = mysql_query("SELECT * FROM transaksi WHERE id_transaksi ='$id'")or die(mysql_error());
$nomor = 1;
while($row_konektransaksi = mysql_fetch_array($query_mysql)){
...
$pdf->Cell(59 ,5,"No. RI/".date("d/M/Y")."/"."00".$row_konektransaksi['id_transaksi'],0,1,'R');//end of line
...
$pdf->Cell(59 ,6,$row_konektransaksi['norekening'],1,1,'R');//end of line

$pdf->Cell(130 ,6,'Tipe Langganan',1,0);
$pdf->Cell(59 ,6,$row_konektransaksi['tipepembayaran'],1,1,'R');//end of line

$pdf->Cell(130 ,6,'Nominal Pembayaran',1,0);
$pdf->Cell(59 ,6,$row_konektransaksi['nominal'],1,1,'R');//end of line

$pdf->Cell(130 ,6,'Tanggal Transaksi',1,0);
$pdf->Cell(59 ,6,$row_konektransaksi['tanggaltransaksi'],1,1,'R');//end of line

$pdf->Cell(130 ,6,'Lama Masa Aktif',1,0);
$pdf->Cell(59 ,6,$row_konekprofhome['masaberlak']. " Hari",1,1,'R');//end of line
...
$pdf->Cell(130 ,6,'Status',1,0);
$pdf->Cell(59 ,6,$row_konektransaksi['status'],1,1,'R');//end of line
