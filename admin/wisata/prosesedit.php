...
$query1="UPDATE wisatadiy set  hari='$hari', tanggaltul='$tanggaltul', penulis='$penulis', judul='$judul', tempatwisata='$tempatwisata', provinsi='$provinsi', kabkota='$kabkota', jeniswisata='$jeniswisata', artikel='$artikel', file='$file', ip='$ip', tanggal='$tanggal', jam='$jam', usernama='$username', status='$status', kategori='$kategori' where id_wisatadiy='$id'";
