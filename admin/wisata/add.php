						...
						<div class="col-md-6 col-md-offset-3 ">
							...
							<div class="form-group">
								...
								<select name="jeniswisata" id="jeniswisata" class="form-control">
								  <option selected="selected" value="">pilih jenis wisata</option>
							...
							<div class="form-group">
								...
								<select name="kategori" id="kategori" class="form-control">
								  <option selected="selected" value="">pilih kategori wisata</option>
							...
							<div class="form-group">
								...
								<select name="hari" id="hari" class="form-control">
									<option selected="selected" value="">pilih hari ber wisata</option>
									<option>senin</option>
