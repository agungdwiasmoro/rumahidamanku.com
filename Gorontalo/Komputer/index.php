            ...
            <div class="box-header col-md-10 col-md-offset-1">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  <li><a href="../Kabupaten Boalemo/index.php"> Kab. Boalemo</a></li>
                  <li><a href="../Kabupaten Bone Bolango/index.php"> Kab. Bone Bolango</a></li>
                  <li><a href="../Kabupaten Gorontalo/index.php"> Kab. Gorontalo</a></li>
                  <li><a href="../Kabupaten Gorontalo Utara/index.php"> Kab. Gorontalo Utara</a></li>
                  <li><a href="../Kabupaten Pohuwato/index.php"> Kab. Pohuwato</a></li>
                  <li><a href="../Kota Gorontalo/index.php"> Kota Gorontalo</a></li>
                </ul>
              </div>
              </td>
