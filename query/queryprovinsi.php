...
mysql_select_db($database_koneksi, $koneksi);
$query_konekprofhome = "SELECT * FROM profilpromo WHERE provinsi = '$provinsi' and status= 'on' ORDER BY id_profilpromo ASC";
...
mysql_select_db($database_koneksi, $koneksi);
$query_konekinformasivid = "SELECT * FROM info WHERE provinsi= '$provinsi' && jenis= 'video' && status='$status' ORDER BY id_info DESC";
...
mysql_select_db($database_koneksi, $koneksi);
$query_konekwisvid = "SELECT * FROM wisatadiy where provinsi = '$provinsi' and jenis='video' && status='on' && kategori='wisata indonesia' ORDER BY id_wisatadiy DESC";
...
mysql_select_db($database_koneksi, $koneksi);
$query_konekwisjateng = "SELECT * FROM wisatadiy where provinsi = '$provinsi' and jenis='photo' && status='on' && kategori='jelajah wisata' ORDER BY id_wisatadiy DESC";
...
mysql_select_db($database_koneksi, $koneksi);
$query_konekwisjatengvid = "SELECT * FROM wisatadiy where provinsi = '$provinsi' and jenis='video' && status='on' && kategori='jelajah wisata' ORDER BY id_wisatadiy DESC";
