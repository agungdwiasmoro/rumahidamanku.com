            ...
            <div class="box-header col-md-10 col-md-offset-1">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  <li><a href="../Kabupaten Majene/index.php"> Kab. Majene</a></li>
                  <li><a href="../Kabupaten Mamasa/index.php"> Kab. Mamasa</a></li>
                  <li><a href="../Kabupaten Mamuju/index.php"> Kab. Mamuju</a></li>
                  <li><a href="../Kabupaten Mamuju Tengah/index.php"> Kab. Mamuju Tengah</a></li>
                  <li><a href="../Kabupaten Pasangkayu/index.php">Kab. Pasangkayu</a></li>
                  <li><a href="../Kabupaten Polewali Mandar/index.php">Kab. Polewali Mandar</a></li>
