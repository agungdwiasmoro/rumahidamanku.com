            ...
            <div class="box-header col-md-10 col-md-offset-1">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  <li><a href="../Kabupaten Buru/index.php"> Kab. Buru</a></li>
                  <li><a href="../Kabupaten Buru Selatan/index.php"> Kab. Buru Selatan</a></li>
                  <li><a href="../Kabupaten Kepulauan Aru/index.php"> Kab. Kepulauan Aru</a></li>
                  <li><a href="../Kabupaten Kepulauan Tanimbar/index.php"> Kab. Kepulauan Tanimbar</a></li>
                  <li><a href="../Kabupaten Maluku Barat Daya/index.php">Kab. Maluku Barat Daya</a></li>
                  <li><a href="../Kabupaten Maluku Tengah/index.php">Kab. Maluku Tengah</a></li>
                  <li><a href="../Kabupaten Maluku Tenggara/index.php">Kab. Maluku Tenggara</a></li>
                  <li><a href="../Kabupaten Seram Bagian Barat/index.php">Kab. Seram Bagian Barat</a></li>
                  <li><a href="../Kabupaten Seram Bagian Timur/index.php">Kab. Seram Bagian Timur</a></li>
                  <li><a href="../Kota Ambon/index.php"> Kota Ambon</a></li>
                  <li><a href="../Kota Tuai/index.php"> Kota Tuai</a></li>
                </ul>
              </div>
              </td>
