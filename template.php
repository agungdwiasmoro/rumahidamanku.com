...
<head>
	...
	<title>One Stop Service for Living</title>
			...
			<section class="content-header">
				<div class="row">
					...
					<div class="col-md-3 col-xs-12" align="center">
						<a href ="admin/login.php" class ="btn btn-primary btn-sm">Masuk</a>
						<a href ="admin/register/index.php" class ="btn btn-success btn-sm">Daftar</a>
			...
			<div class="row" >
				<div class="col-md-3 col-xs-3">
					...
					<div class="small-box bg-ta">
						<a href="properti.php" title="properti di rumahidamanku.com" target="_self"><img src="image/Background main frame.JPG" loading="lazy" alt="Properti di Rumah, Rumah Idaman, Rumah Idamanku" title="Properti di Rumah, Rumah Idaman, Rumah Idamanku" class="img-fluid" width="100%">
						<a href="properti.php" title="properti di rumahidamanku.com" target="_self" class="small-box-footer">Properti</a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-md-3 col-xs-3">
					<!-- small box -->
					<div class="small-box bg-ta">
						<a href="mobil.php" title="mobil di rumahidamanku.com" target="_self"><img src="image/audi_locus_concept_car.jpg" loading="lazy" alt="Mobil di Rumah, Rumah Idaman, Rumah Idamanku punya mobil" title="Mobil di Rumah, Rumah Idaman, Rumah Idamanku punya mobil" class="img-fluid" width="100%">
						<a href="mobil.php" title="mobil di rumahidamanku.com" target="_self" class="small-box-footer">Mobil</a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-md-3 col-xs-3">
					<!-- small box -->
					<div class="small-box bg-ta">
						 <a href="motor.php" title="motor di rumahidamanku.com" target="_self"><img src="image/big_kawasaki_ninja_zx.jpg" loading="lazy" alt="Motor di Rumah, Rumah Idaman, Rumah Idamanku punya motor" title="Motor di Rumah, Rumah Idaman, Rumah Idamanku punya motor" class="img-fluid" width="100%">
						<a href="motor.php" title="motor di rumahidamanku.com" target="_self" class="small-box-footer">Motor</a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-md-3 col-xs-3">
					<!-- small box -->
					<div class="small-box bg-ta">
						 <a href="elektronika.php" title="Elektonik di rumahidamanku.com" target="_self"><img src="image/elektronika.JPG" loading="lazy" alt="Elektronika di Rumah, Rumah Idaman, Rumah Idamanku punya elektronika" title="Elektronika di Rumah, Rumah Idaman, Rumah Idamanku punya elektronika" class="img-fluid" width="100%" >
						<a href="elektronika.php" title="Elektonik di rumahidamanku.com" target="_self" class="small-box-footer">Elektronika</a>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-xs-3">
					<!-- small box -->
					<div class="small-box bg-ta">
						 <a href="komputer.php" title="komputer di rumahidamanku.com" target="_self"><img src="image/komputer.GIF" loading="lazy" alt="Komputer di Rumah, Rumah Idaman, Rumah Idamanku punya komputer" title="Komputer di Rumah, Rumah Idaman, Rumah Idamanku punya komputer" class="img-fluid" width="100%" >
						<a href="komputer.php" title="komputer di rumahidamanku.com" target="_self" class="small-box-footer">Komputer</a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-md-3 col-xs-3">
				<!-- small box -->
					<div class="small-box bg-ta">
						<a href="industri.php" title="industri di rumahidamanku.com" target="_self"><img src="image/Telur Asin Bebek 5.JPG" loading="lazy" alt="Industri di Rumah, Rumah Idaman, Rumah Idamanku" title="Industri di Rumah, Rumah Idaman, Rumah Idamanku" class="img-fluid" width="100%" >
						<a href="industri.php" title="industri di rumahidamanku.com" target="_self" class="small-box-footer">Industri </i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-md-3 col-xs-3">
					<!-- small box -->
					<div class="small-box bg-ta">
						<a href="wisata.php" title="wisata di rumahidamanku.com" target="_self"><img src="image/traveling.jpg" loading="lazy" alt="Wisata di Rumah, Rumah Idaman, Rumah Idamanku" title="Wisata di Rumah, Rumah Idaman, Rumah Idamanku" class="img-fluid" width="100%" ></a>
						<a href="wisata.php" title="wisata di rumahidamanku.com" target="_self" class="small-box-footer">Wisata </a>
					</div>
				</div>
