				...
				<div class="col-md-12">
					<div class="box box-solid">
						<div class="box-header with-border">
							<h2 class="box-title">Hubungi Kami</h2>
						</div>
						<div class="box-body">
						  <dl class="dl-horizontal">
							<dt>Kontak</dt>
							<dd><a href="https://api.whatsapp.com/send?phone=6285228757757" style="border-bottom: 1px solid;">+6285 2287 57757</a></dd><hr>
							<dt>E-mail</dt>
							<dd>sigit_bp2005@yahoo.co.id<br>
							rumahidamanku.com@gmail.com</dd><hr>
							<dt>Alamat</dt>
							<dd><addres>Jl. Dr. Wahidin Sudiro Husodo No. 33, Klaten, Jawa Tengah Indonesia</addres></dd>
						  </dl>
						</div>
						<!-- /.box-body -->
					</div>
