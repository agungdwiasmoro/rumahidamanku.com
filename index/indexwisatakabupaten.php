<div align="center" style="margin-top: -20px !important; margin-bottom: 5px; ">
	...
	<div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <h3 align="center">Promo Usaha</h3>
              ...
              <?php do { ?>
              <table class="col-md-10 col-md-offset-1 col-xs-12 col-xs-12 table-responsive" rules="none" border="1px" >
              <tr>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
				<div class="box-header with-border col-md-10 col-md-offset-1 col-xs-12">
				...
				<div class="box-body">
					...
					<table class="col-md-10 col-md-offset-1 col-xs-12 col-xs-12">
						<tr>
						...
						<tr>
							<td  width="50%"><div align="center"><img src="../../../imageViewwis.php?image_id=<?php echo $row_konekwis['id_wisatadiy']; ?>" loading="lazy" class="img-fluid" title="<?php echo $row_konekwis['infogambar']; ?> , <?php echo $row_konekwis['kabkota']; ?>" , <?php echo $row_konekwis['provinsi']; ?> alt="gambar <?php echo $row_konekwis['infogambar']; ?>"  style="width: 90%; " /></div></td>
					...
					<table class="col-md-10 col-md-offset-1 col-xs-12 col-xs-12">
						...
						<tr>
							<td width="50%"><div align="center"><video id='video2' class='video-js vjs-default-skin' style="width: 90%;" controls="controls" preload= "auto">
