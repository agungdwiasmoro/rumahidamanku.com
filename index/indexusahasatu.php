		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-body">
					...
					<p align="center"><strong><img src="../../../imageView.php?image_id=<?php echo $row_konekprofkodkabdiy['id_profkabkod']; ?>" loading="lazy" title="Lambang <?php echo $row_konekprofkodkabdiy['kodkab']; ?> , <?php echo $row_konekprofkodkabdiy['provinsi']; ?>" alt="Lambang <?php echo $row_konekprofkodkabdiy['kodkab']; ?> , <?php echo $row_konekprofkodkabdiy['provinsi']; ?>" style="width: 135px; "/></strong></p>
				</div>
			</div>
		</div>
	</div>
	  ...
	  <div class="row">
		...
		<div class="col-md-6 col-xs-12">
			<div class="box">
				...
				<div class="box-body">
					<center><iframe src="<?php echo $row_konekprofhome['goomapping1']; ?>" loading="lazy" width="90%" frameborder="0" style="border:0" title="klik peta untuk panduan dengan google maps" alt="klik peta untuk panduan dengan google maps" allowfullscreen></iframe></center>
				</div>
			</div>
		</div>
	</div>
