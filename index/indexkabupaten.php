...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="box">
          <a href="Properti/index.php"><div class="box-header">
              <h3>Properti</h3><hr>
          </div></a>
          <div class="box-body">
              <!-- Content Usaha -->
        ...
        <div class="box">
          <a href="Industri/index.php"><div class="box-header">
            <h3>Industri</h3><hr>
          </div></a>
          <div class="box-body">
            <!-- Content Usaha -->
        ...
        <div class="box">
          <a href="Komputer/index.php"></a><div class="box-header">
            <h3>Komputer</h3><hr>
          </div>
          <div class="box-body">
              <!-- Content Usaha -->
        ...
        <div class="box">
          <a href="Elektronika/index.php"><div class="box-header">
        ...
        <div class="box">
          <a href="Motor/index.php"><div class="box-header">
          <h3>Motor</h3><hr>
          </div></a>
          <div class="box-body">
            <!-- Content Usaha -->
        ...
        <div class="box">
          <a href="Mobil/index.php"><div class="box-header">
          <h3>Mobil</h3><hr>
          </div></a>
          <div class="box-body">
            <!-- Content Usaha -->
        ...
        <div class="box">
          <a href="Wisata/index.php"><div class="box-header">
          <h3>Wisata</h3><hr>
          </div></a>
          <div class="box-body">
            <!-- Content Usaha -->
