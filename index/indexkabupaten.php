        ...
        <div class="col-md-12">
          <div class="box">
				<div class="box-header with-border col-md-10 col-md-offset-1 col-xs-12">
				  ...
				  <marquee><small>Explore Indonesia Dengan Semua Keindahannya</small></marquee>
				</div>
				<div class="box-body">
      ...
      <div class="row">
        <div class="col-md-12 col xs-12">
          <div class= "box">
            ...
            <table  align="center">
              <tr>
                <td style="padding: 2px;"><button type="button" class="btn btn-block btn-default btn-xs" align="center"><strong><a href="<?php printf("%s?pageNum_konekinformasi=%d%s", $currentPage, 0, $queryString_konekinformasi); ?>" title="awal Informasi <?php echo $row_konekprofkabkodjateng['provinsi']; ?> Indonesia" alt="awal Informasi <?php echo $row_konekprofkabkodjateng['provinsi']; ?> Indonesia " target="_self">Awal</a></strong></button></td>
                
                <td style="padding: 2px;"><button type="button" class="btn btn-block btn-default btn-xs" align="center"><strong><a href="<?php printf("%s?pageNum_konekinformasi=%d%s", $currentPage, max(0, $pageNum_konekinformasi - 1), $queryString_konekinformasi); ?>" title=" sebelumnya Informasi <?php echo $row_konekprofkabkodjateng['provinsi']; ?> Indonesia" alt="sebelumnya Informasi <?php echo $row_konekprofkabkodjateng['provinsi']; ?> Indonesia" target="_self">Sebelumnya</a></strong></button></td>
