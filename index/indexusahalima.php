	...
	<div class="row">
					...
					<table class="col-md-6 col-xs-12 col-md-offset-3" border="1px" align="center">
						<tr>
							<td>
								...
								<br>Lamaran Terakhir dikirim :  <?php echo $row_koneklokerdiy['tanggalakhir']; ?>
							</td>
						</tr>
					</table>
				</div>
	  ...
	  <div class="row">
		...
		<div class="col-md-4 col-xs-12">
			<div class="box">
				<div class="box-header with-border">
				<h3 align="center">Cabang Kedua</h3>
				</div>
				<div class="box-body">
					<center><iframe src="<?php echo $row_konekprofhome['goomapping2']; ?>" width="90%" frameborder="0" style="border:0" title="klik peta untuk panduan dengan google maps" alt="klik peta untuk panduan dengan google maps" allowfullscreen></iframe></center>		
				</div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-4 col-xs-12">
			<div class="box">
				<div class="box-header with-border">
				<h3 align="center">Cabang Ketiga</h3>
				</div>
				<div class="box-body">
					<center><iframe src="<?php echo $row_konekprofhome['goomapping3']; ?>" width="90%" frameborder="0" style="border:0" title="klik peta untuk panduan dengan google maps" alt="klik peta untuk panduan dengan google maps" allowfullscreen></iframe></center>		
				</div>
			</div>
		</div>
		<div class="col-md-4 col-xs-12">
			<div class="box">
				<div class="box-header with-border">
				<h3 align="center">Cabang Keempat</h3>
				</div>
				<div class="box-body">
					<center><iframe src="<?php echo $row_konekprofhome['goomapping4']; ?>" width="90%" frameborder="0" style="border:0" title="klik peta untuk panduan dengan google maps" alt="klik peta untuk panduan dengan google maps" allowfullscreen></iframe></center>		
				</div>
			</div>
		</div>
		<div class="col-md-4 col-xs-12">
			<div class="box">
				<div class="box-header with-border">
				<h3 align="center">Cabang Kelima</h3>
				</div>
				<div class="box-body">
					<center><iframe src="<?php echo $row_konekprofhome['goomapping5']; ?>" width="90%" frameborder="0" style="border:0" title="klik peta untuk panduan dengan google maps" alt="klik peta untuk panduan dengan google maps" allowfullscreen></iframe></center>		
				</div>
			</div>
		</div>
	</div>
